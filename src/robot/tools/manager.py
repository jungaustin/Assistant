...
class ToolManager:
    ...
    def initialize_tools(self):
        ...
        all_tools.append(self.log_tools.create_log_meal_tool())
        all_tools.append(self.log_tools.create_lookup_food_tool())
        ...
        all_tools.append(self.web_tools.create_lookup_food_calories_tool())
